...
is scoped to the host network namespace, while the current eBPF program is
host-wide and observes all network namespaces. Sampling boundaries can also
place events just outside the first-to-last delta.
